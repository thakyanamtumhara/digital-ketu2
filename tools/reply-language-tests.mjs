...
const cases = [
  ...
  ['English colour relation', { buyerText: 'Cotton shirts in Navy and Black colours' }, true],
  ['English estimate request after Hindi', { buyerText: 'Estimate delivery time to Pune?', history: [{ buyerMessage: 'Mujhe shirts chahiye' }] }, true],
  ['English estimate retains explicit Hindi', { buyerText: 'Estimate delivery time?', preferredLanguage: 'hindi' }, false],
  ['English colour relation retains explicit Hindi', { buyerText: 'Shirts in Navy and Black', history: [{ buyerMessage: 'Hindi mein batao' }] }, false],
  ['Hindi colour question remains Hindi', { buyerText: 'Shirts in Navy and Black mein milega kya?' }, false],
  ['Hindi estimate question remains Hindi', { buyerText: 'Delivery estimate batao' }, false],
  ['colour nouns alone stay unclassified', { buyerText: 'Navy and Black cotton shirts' }, false],
  ['one new marker alone stays unclassified', { buyerText: 'Estimate' }, false],
  ['links do not supply language markers', { buyerText: 'Navy https://example.invalid/in/estimate' }, false],
  ['non-Latin estimate remains outside English', { buyerText: 'Delivery estimate बताओ' }, false],
