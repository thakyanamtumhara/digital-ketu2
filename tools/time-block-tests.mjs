...
const morning = istTimeBlock(at('2026-09-11T08:32:00+05:30'))
t('Morning caller is told today after 10am', /call today after 10am/.test(morning), true)
t('Morning warehouse opens today', /NOT OPEN YET: opens TODAY at 10am/.test(morning), true)
t('Morning does not say the warehouse closed for the day', /kal nikal jayega|aaj godam band ho gaya/.test(morning), false)
t('Sunday before opening uses 11am today', /opens TODAY at 11am/.test(istTimeBlock(at('2026-09-13T10:30:00+05:30'))), true)
t('Evening caller still waits until tomorrow', /call tomorrow after 10am/.test(istTimeBlock(at('2026-09-11T20:00:00+05:30'))), true)
t('After midnight caller waits until today', /call today after 10am/.test(istTimeBlock(at('2026-09-12T00:01:00+05:30'))), true)
