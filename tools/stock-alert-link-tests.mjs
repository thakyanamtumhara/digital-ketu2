...
const cases = [
  ...
  ['stock sheet uses upgraded link', 'Live stock https://www.bulkplaintshirt.com/delhi-stock.html', 'Live stock ' + own],
  ['Coming Soon link uses upgraded destination', 'Check Coming Soon https://www.bulkplaintshirt.com/delhi-stock.html', 'Check Coming Soon ' + own],
  ['distinct timing and alert links', 'Coming Soon timing: https://www.bulkplaintshirt.com/delhi-stock.html\nSet a stock alert here: ' + STOCK_ALERT_URL, 'Coming Soon timing: ' + own + '\nSet a stock alert here: ' + own],
  ['later stock link also uses upgraded destination', 'You can set alerts. For timing, check Coming Soon https://www.bulkplaintshirt.com/delhi-stock.html', 'You can set alerts. For timing, check Coming Soon ' + own],
