...
const REASONS = new Set(['awaiting_validation', 'already_promoted', 'same_topic', 'missing_text', 'missing_media_context', 'missing_timing_subject', 'garbled_transcript', 'holding_line', 'transactional_reply', 'not_stock_timing', 'perishable_stock_answer', 'perishable_price_answer', 'untrusted_origin', 'different_topic', 'incomplete_validator_response', 'ambiguous_validator_response', 'validator_unavailable', 'stored_in_knowledge'])
