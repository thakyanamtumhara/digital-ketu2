      ...
      try {
        ...
        if (convId) {
          ...
          for (const r of recent) {
            ...
            if (r.status === 'REPLIED' && r.deferReason !== 'welcome_followup_generic' && r.deferReason !== 'claude_partial_answer') break  // a real answer went out (a partial's own answer is not one for the held part)
