...
Reply with exactly one word: KETU or ASSISTANT.`,
  ...
  const STOCK_INTENT_RE = new RegExp(
    'stock|avail|milega|milegi|mil\\s*(jayega|sakta|sakti)|restock|refill|\\bupdate\\b|aa\\s*(gaya|gay[ei]|jayega|raha)|aayega|ayega|kab\\s*(aa|tak|milega|mileg)'  // 2026-09-08: 'cotton polo navy 42 44 update' had no block and was held
