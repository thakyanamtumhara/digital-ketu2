...
- FIT — DROP-SHOULDER vs REGULAR: ALL our Oversize tees (180/210/240gsm), AcidWash Oversize, and Boxy Fit are DROP-SHOULDER fit (catalog-confirmed — every Oversize description reads "Oversized Drop-shoulder"). Our REGULAR / NON-drop-shoulder fit tee is the ROUND NECK range (Biowash / True Biowash / Non-Bio Round Neck, all Regular Fit). So if a buyer wants a NORMAL / REGULAR fit or explicitly does NOT want drop-shoulder, steer them to a Round Neck — NEVER offer an Oversize as a "non-drop-shoulder" option (there is NO non-drop-shoulder oversize). (Off-shoulder = drop-shoulder = oversize still holds; this only governs steering a buyer who wants regular fit.)
