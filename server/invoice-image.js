...
Otherwise, is this a FINALIZED purchase BILL / tax INVOICE / payment RECEIPT — a generated document with a bill/invoice number, or a completed-payment confirmation (e.g. a UPI/bank "payment successful" screen)? A shopping cart, product listing, quotation or payment request without completed-order evidence is NOT a bill — reply NO for those. Never infer completed payment just from an amount, product quantities or "Order Summary" heading.
